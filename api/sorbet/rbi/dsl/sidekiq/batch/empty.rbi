...
# This is an autogenerated file for dynamic methods in `Sidekiq::Batch::Empty`.
# Please instead update this file by running `bin/tapioca dsl Sidekiq::Batch::Empty`.
