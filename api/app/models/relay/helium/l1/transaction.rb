  ...
  module Helium
    module L1
      class Transaction < ApplicationRecord
        ...
        has_many :rewards, class_name: "Relay::Helium::L1::Reward", foreign_key: :transaction_hash, primary_key: :transaction_hash, dependent: :destroy, inverse_of: :helium_transaction
        has_many :dc_burns, class_name: "Relay::Helium::L1::DcBurn", foreign_key: :transaction_hash, primary_key: :transaction_hash, dependent: :destroy, inverse_of: :helium_transaction
      end
    end
  end
end
