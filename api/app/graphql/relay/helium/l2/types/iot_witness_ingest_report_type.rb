...
module Relay
  module Helium
    module L2
      module Types
        class IotWitnessIngestReportType < Relay::Types::BaseObject
          extend T::Sig
          ...
          field :data, Relay::Types::BinaryType, null: true, description: "The data of the witness ingest report."
          ...
          field :signature, Relay::Types::BinaryType, null: true, description: "The signature of the witness ingest report."
        end
      end
    end
  end
