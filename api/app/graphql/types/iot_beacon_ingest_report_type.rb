...
module Types
  class IotBeaconIngestReportType < Types::BaseObject
    extend T::Sig
    ...
    field :data, String, null: true, description: "The data of the beacon ingest report."
    ...
    field :local_entropy, String, null: true, description: "The local entropy of the beacon ingest report."
    field :remote_entropy, String, null: true, description: "The remote entropy of the beacon ingest report."
    field :signature, String, null: true, description: "The signature of the beacon ingest report."
  end
end
