...
module Types
  class MobileRewardShareType < Types::BaseObject
    ...
    field :seniority_timestamp, GraphQL::Types::BigInt, null: true, description: "The seniority timestamp."
    ...
    field :sp_boosted_hex_status, Integer, null: true, description: "The service provider boosted hex status."
    field :oracle_boosted_hex_status, Integer, null: true, description: "The oracle boosted hex status."
